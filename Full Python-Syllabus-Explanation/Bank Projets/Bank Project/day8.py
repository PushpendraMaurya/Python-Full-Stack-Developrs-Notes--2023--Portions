...
class Bank(Admin):
    ...
    def CheckEmail(self):
        pass
    query = ''' select email from UserDetails_j where email '''

    # Check Info
    def CheckInfo(self,c_contact,c_email):
        self.connection()
        ...
        if record is None:
            ...
            return "Contact You Entered already Exists"
    ...
    def CreateAccount(self,c_name,c_contact,c_email,address,created_at,account_no,amount):
        self.connection()
        query = '''insert into UserDetails_j(cname,contact,email,address,created_at,account_no,amount,password) values
        (%s,%s,%s,%s,%s,%s,%s, Null);'''
                ...
                while True:
                    ...
                    if ach =="1":
                        ...
                        if Check_Info ==True:
                            ...
                            # password 
                            Check_Info = App.CreateAccount(c_name,c_contact,c_email,address,created_at,account_no,amount)
